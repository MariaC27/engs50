...
int main(void){	
	...
	int res1 = lqput(lqp_1, (void *)one_p);
	int res2 = lqput(lqp_1, (void *)two_p);
	int res3 = lqput(lqp_1, (void *)three_p);
	...
	lqclose(lqp_1);	// qclose should deallocate queue and its 3 elements
